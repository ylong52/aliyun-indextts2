    ...
    def post_init_gpt2_config(self, use_deepspeed=False, kv_cache=False, half=False):
        ...
        if self.use_accel and torch.cuda.is_available():
            ...
            try:
                ...
                print("Warning: flash_attn is not installed. Acceleration engine will be disabled.")
                print("To enable acceleration, install flash_attn from https://github.com/Dao-AILab/flash-attention/releases/")
            ...
            if self.use_accel:
                try:
                    ...
                    print(f"Warning: Failed to import acceleration modules: {e}")
                    print("Acceleration engine will be disabled.")
                    self.use_accel = False
